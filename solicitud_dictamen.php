...
session_start();
	...
	$row3=mysql_fetch_array($datosfi);
	...
	$row4=mysql_fetch_array($mundafisca);
...
<br>
	...
	<div id="dato">
		<p 'text-align:justify;'>
		         Con fundamento en el al Artículo 61 del Decreto No. 415, por el que se Reforman,
		          Adicionan y Derogan, diversas disposiciones de la Ley de Hacienda del Estado de Colima, 
		          publicado el sábado 26 de noviembre del año 2011, en el Periódico Oficial “El Estado de Colima”; y 
		          el Decreto que Reforma el artículo 25, fracción XX y se Adiciona la fracción XXI y XXII, del
		          Reglamento Interior de los Servicios de Salud del Estado; referente al Dictamen técnico de la 
		          infraestructura física, funcional y operativa, de establecimientos de servicios de salud
		</p>
	</div>
	</br><br><br>
	<table class="marca">
		...
		<tbody>
			<tr>
				...
				<td style="border:inset 0pt">Dictamen de Infraestructura</td>
			</tr>
		</tbody>
	</table>
	</br><br><br><br>
	...
	<table id="tabla" style="width:100%" class="solicitudes">	
		...
		<tbody>
			...
			<tr>
				<td>CALLE Y NUMERO</td>
				<td><?=$row3['df_calle']?>&nbsp;#<?=$row3['df_numero']?></td>
			</tr>
			<tr>
				<td>COLONIA</td>
				<td><?=$row3['cl_nombre']?></td>
			</tr>
			<tr>
				<td>DELEGACION O MUNICIPIO</td>
				<td><?=$row4['mp_nombre']?></td>
			</tr>		
		</tbody>		
	</table>
	<br/>
...
<?php
	...
	$dompdf->render();
	$pdf = $dompdf->output();
	$filename = "solicitud_dictamen".time().'.pdf';
