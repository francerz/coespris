...
$query = "SELECT * FROM municipio inner join estado using(id_estado)";
$result = mysql_query($query,$dbConn);
$title="Consulta Municipios";
?>
<!DOCTYPE HTML>
<html lang='es'> 
<head>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="table-responsive">
              <form action="municipio_restablecer.php" method='POST'>
