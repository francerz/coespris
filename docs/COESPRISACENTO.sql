...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2015 a las 06:34:53
...
INSERT INTO `asistentes` (`id_grupo`, `id_cliente`, `estatus`, `id_solicitud`) VALUES
(5, 3, 'ACTIVO', 7),
(5, 4, 'ACTIVO', 7),
(5, 5, 'ACTIVO', 7);
...
(1, '2015-10-02 12:50:51', 'ANTONIO ZEPEDA MENDOZA', 41, 5, 2),
(2, '2015-10-02 12:54:44', 'ANTONIO ZEPEDA MENDOZA', 48, 6, 2);
...
(2, 'ADRIAN', 'GONZALEZ', 'GONZALEZ', 'LOS REGALADOS', 787, 5),
(3, 'DFG', 'DFG', 'DFG', 'dfg', 12, 1),
(4, 'DFG', 'DFG', 'DFG', 'ghj', 12, 1),
(5, 'DFG', 'DFG', 'DGF', 'dfg', 12, 1);
...
(2, 'GSDFG21344124', 'GENERICO', 'TECNOLOGICO', 121, 1, 'correo@mail.com');
...
`id_dat_sec_autorizacion` int(11) NOT NULL,
  `dsa_nombre` varchar(355) COLLATE utf8_unicode_ci NOT NULL,
...
(3, 'DENOMINACI&Oacute;N:', 'texto', 'required', 'no_denominacion'),
...
(7, 'TELEF&Oacute;NO:', 'texto', 'required', 'key_telefono'),
...
(11, 'CLASIFICACI&Oacute;N AUTORIZADA PARA:', 'radio', '464111 (CON MINISUPER);464112(SIN MINISUPER);', 'key_clas_aut'),
(12, 'PSICOTROPICOS', 'boolean', '', 'key_psico'),
(13, 'VACUNAS', 'boolean', '', 'key_vacunas'),
(14, 'TOXOIDES', 'boolean', '', 'key_toxoides'),
(15, 'SUEROS Y TOXINAS DE ORIGEN ANIMAL', 'boolean', '', 'key_saoa'),
(16, 'HEMODERIVADOS', 'boolean', '', 'key_hemo'),
(17, 'LUGAR DE DESTINO:', 'texto', 'required', 'key_destino'),
(18, 'EMBALSAMADO', 'radio', 'SI;NO;', 'key_embal'),
(19, 'ORIGINAL DE LA CERTIFICACI&Oacute;N DE UN M&Eacute;DICO CON T&Iacute;TULO LEGALMENTE EXPEDIDO, DE LAS CIRCUNSTANCIAS PREVIAS AL FALLECIMIENTO DE LA PERSONA DE CUYO CAD&Aacute;VER SE HUBIEREN EXTRA&Iacute;DO LOS &Oacute;RGANOS,  TEJIDOS Y SUS COMPONENTES Y C&Eacute;LULAS QUE SE PRETENDEN INTERNAR', 'boolean', 'INTERNACION AL TERRITORIO NACIONAL DE ORGANOS, TEJIDOS Y  SUS COMPONENTES Y CELULAS ', 'key_Ai_certi_me'),
(20, 'ORIGINAL DE LA DOCUMENTACI &Oacute;N CONSTITUTIVA DE LA INSTITUCI &Oacute;N QUE REALICE LA INTERNACI &Oacute;N', 'boolean', '', 'key_Ai_doc_con'),
(21, 'DOCUMENTO QUE ACREDITE EL FUNCIONAMIENTO LEGAL DEL ESTABLECIMIENTO QUE OTORGA LOS &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C &Eacute;LULAS', 'boolean', 'DEL ESTABLECIMIENTO EN EL EXTRANJERO', 'key_Ai_doc_acr'),
(22, 'AUTORIZACI &Oacute;N DEL GOBIERNO PARA LA SALIDA DE &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C &Eacute;LULAS DEL PA &Iacute;S.', 'boolean', '', 'key_Ai_autori'),
(23, 'CONSTANCIA DE QUE EL ESTABLECIMIENTO OTORGA LOS &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C&Eacute;LULAS A T&Iacute;TULO GRATUITO', 'boolean', '', 'key_Ai_const'),
(24, 'CERTIFICACI &Oacute;N DE QUE LOS &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C &Eacute;LULAS,  EST&Aacute;N EXENTOS DE CUALQUIER PATOLOG&Iacute;A', 'boolean', '', 'key_Ai_cert_or'),
(25, 'DOCUMENTACI&Oacute;N SOBRE LA V&Iacute;A DE ENTRADA AL TERRITORIO NACIONAL', 'boolean', '', 'key_Ai_doc_via'),
(26, 'ORIGINAL DE LA CERTIFICACI&Oacute;N DE UN M&Eacute;DICO CON T&Iacute;TULO LEGALMENTE EXPEDIDO, DE LAS CIRCUNSTANCIAS PREVIAS AL FALLECIMIENTO DE LA PERSONA DE CUYO CAD&Aacute;VER SE HUBIEREN EXTRA&Iacute;DO LOS &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C&Eacute;LULAS.', 'boolean', 'SALIDA DEL TERRITORIO NACIONAL DE ORGANOS, TEJIDOS Y SUS COMPONENTES Y CELULAS.', 'key_As_certi_me'),
(27, 'ORIGINAL DE LA DOCUMENTACI&Oacute;N CONSTITUTIVA DE LA INSTITUCI&Oacute;N QUE REALICE LA SALIDA DEL PA&Iacute;S', 'boolean', '', 'key_As_doc_con'),
(28, 'DOCUMENTO QUE ACREDITE EL FUNCIONAMIENTO LEGAL DEL ESTABLECIMIENTO QUE OTORGA LOS &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C&Eacute;LULAS.', 'boolean', 'DEL ESTABLECIMIENTO EN EL PAIS.', 'key_As_doc_acr'),
(29, 'CONSTANCIA DE QUE EL ESTABLECIMIENTO OTORGA LOS &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C&Eacute;LULAS A T&Iacute;TULO GRATUITO.', 'boolean', '', 'key_As_const'),
(30, 'CERTIFICACI&Oacute;N DE QUE LOS &Oacute;RGANOS, TEJIDOS Y SUS COMPONENTES Y C&Eacute;LULAS, EST&Aacute;N EXENTOS DE CUALQUIER PATOLOG&Iacute;A', 'boolean', '', 'key_As_cert_or'),
(31, 'DOCUMENTACI&Oacute;N SOBRE LA V&Iacute;A DE SALIDA DEL TERRITORIO NACIONAL', 'boolean', '', 'key_As_doc_via'),
(32, 'CERTIFICADO Y ACTA DE DEFUNCI&Oacute;N', 'boolean', 'DOCUMENTOS PARA EL TRASLADO DE CADAVERES', 'key_B_certi'),
(33, 'COMPROBANTE DE LA TESIS DE EMBALSAMAMIENTO, EN CASO DE QUE LA DISTANCIA POR RECORRER SEA MAYOR A 300 KMS. O TRANSCURRAN M&Aacute;S DE 48 HORAS. A PARTIR DEL MOMENTO DE LA DEFUNCI&Oacute;N', 'boolean', '', 'key_B_comprob'),
(34, 'CARTA PODER DEL PARTICULAR A LA FUNERARIA, ASENTANDO EN &Eacute;STA LA V&Iacute;A DE TRASLADO A&Eacute;REA, TERRESTRE O MAR&Iacute;TIMA A UTILIZAR.', 'boolean', '', 'key_B_carta'),
(35, 'SOLICITUD ESCRITA DE ALG&Uacute;N DISPONENTE SECUNDARIO, REPRESENTANTE LEGAL O QUI&Eacute;N DEMUESTRE INTER&Eacute;S JUR&Iacute;DICO, SEÑALANDO LA CAUSA DE LA SOLICITUD.', 'boolean', 'DOCUMENTOS PARA EMBALSAMAMIENTO', 'key_B_solici'),
(36, 'ORIGINAL Y COPIA DEL CERTIFICADO DE DEFUNCI&Oacute;N.', 'boolean', '', 'key_B_cert_def'),
(37, 'ORIGINAL Y COPIA DE LA DOCUMENTACI&Oacute;N QUE ACREDITE LA LEGITIMACI&Oacute;N DEL SOLICITANTE Y DE LOS MOTIVOS DE LA SOLICITUD. (CREDENCIAL DE ELECTOR O PASAPORTE VIGENTE)', 'boolean', '', 'key_B_motivos'),
(38, 'CERTIFICADO Y ACTA DE DEFUNCI&Oacute;N, TRADUCIDOS AL ESPAÑOL Y CERTIFICADOS POR LAS AUTORIDADES CONSULARES MEXICANAS', 'boolean', 'DOCUMENTOS PARA INTERNAMIENTO DE CADAVERES', 'key_C_certi'),
(39, 'COMPROBANTE DE EMBALSAMAMIENTO, TRADUCIDO AL ESPAÑOL Y CERTIFICADO POR LAS AUTORIDADES CONSULARES MEXICANAS, EN EL PA&Iacute;S DONDE OCURRI&Oacute; EL DECESO', 'boolean', '', 'key_C_comprob'),
(40, 'PERMISO DEL TRASLADO INTERNACIONAL OTORGADO POR LA AUTORIDAD SANITARIA DEL PA&Iacute;S DONDE HAYA OCURRIDO EL FALLECIMIENTO, TRADUCIDO AL ESPAÑOL Y CERTIFICADO POR LAS AUTORIDADES CONSULARES MEXICANAS.', 'boolean', '', 'key_C_permiso'),
(41, 'ORIGINAL DE LA CARTA PODER DEL PARTICULAR A LA AGENCIA FUNERARIA QUE EFECT&Uacute;A EL TRASLADO, ASENTANDO LA V&Iacute;A DE TRASLADO (A&Eacute;REA, MAR&Iacute;TIMA O TERRESTRE A UTILIZAR).', 'boolean', '', 'key_C_carta'),
(42, 'COMPROBANTE DE INHUMACI&Oacute;N', 'boolean', 'INTERNAMIENTO DE RESTOS ARIDOS', 'key_Ci_compro'),
(43, 'INFORMACI&Oacute;N SOBRE LA V&Iacute;A A&Eacute;REA, MAR&Iacute;TIMA O TERRESTRE QUE SE UTILIZAR&Aacute;', 'boolean', '', 'key_Ci_via'),
(44, 'ESPECIFICACI&Oacute;N DEL DESTINO DE LOS RESTOS', 'boolean', '', 'key_Ci_destino'),
(45, 'CERTIFICADO O ACTA DE DEFUNCI&Oacute;N.', 'boolean', 'SALIDA DE CADAVERES', 'key_Cs_certifi'),
(46, 'COMPROBANTE DE LA TESIS DE EMBALSAMAMIENTO', 'boolean', '', 'key_Cs_comp'),
(47, 'ORIGINAL DE LA CARTA PODER DEL PARTICULAR A LA AGENCIA FUNERARIA QUE EFECT&Uacute;A EL TRASLADO, ASENTANDO EN ESTA LA VÍA DE TRASLADO (A&Eacute;REA, MAR&Iacute;TIMA O TERRESTRE A UTILIZAR)', 'boolean', '', 'key_Cs_carta'),
(48, 'COMPROBANTE DE INHUMACI&Oacute;N', 'boolean', 'SALIDA DE RESTOS ARIDOS', 'key_Csr_comp_in'),
(49, 'COMPROBANTE DE EXHUMACI&Oacute;N COMO RESIDUOS CUMPLIDOS', 'boolean', '', 'key_Csr_comp_ex'),
(50, 'INFORMACI&Oacute;N SOBRE LA V&Iacute;A DE TRASLADO (A&Eacute;REA, MAR&Iacute;TIMA O TERRESTRE A UTILIZAR)', 'boolean', '', 'key_Csr_via'),
(51, 'ESPECIFICACI&Oacute;N DEL DESTINO FINAL DE LOS RESTOS.', 'boolean', '', 'key_Csr_desti'),
(52, 'CERTIFICADO O ACTA DE DEFUNCI&Oacute;N', 'boolean', 'PARA LA EXHUMACION PREMATURA', 'key_D_certi'),
(53, 'COMPROBANTE DE INHUMACI&Oacute;N', 'boolean', '', 'key_D_comp_in'),
(54, 'ORDEN GIRADA POR MINISTERIO P&Uacute;BLICO O AUTORIDAD JUDICIAL, PARA LA EXHUMACI&Oacute;N PREMATURA', 'boolean', '', 'key_D_orden'),
(55, 'COMPROBANTE DE INHUMACI&Oacute;N', 'boolean', 'PARA LA EXHUMACION', 'key_E_comp_in'),
(56, 'ORIGINAL DE LA CARTA PODER DEL PARTICULAR HACIA LA AGENCIA FUNERARIA, ASENTANDO EN &Eacute;STA LA V&Iacute;A DE TRASLADO (A&Eacute;REA, MAR&Iacute;TIMA O TERRESTRE A UTILIZAR).', 'boolean', '', 'key_E_carta'),
(57, 'IDENTIFICACI&Oacute;N DEL SOLICITANTE (CREDENCIAL DE ELECTOR O PASAPORTE VIGENTE).', 'boolean', '', 'key_E_identifi'),
(58, 'ESPECIFICACI&Oacute;N DEL DESTINO FINAL DE LOS RESTOS.', 'boolean', '', 'key_E_destino'),
(59, 'CERTIFICADO O ACTA DE DEFUNCI&Oacute;N.', 'boolean', 'PARA LA INHUMACION O INCINERACION DE CADAVERES SI SE EFECTUA ANTES DE 12 HRS. O DESPUES DE 48 DE OCURRIDO EL DECESO', 'key_F_certi_def'),
(60, 'COMPROBANTE DE LA TESIS DEL EMBALSAMAMIENTO, CUANDO SE REALICE LA INHUMACI&Oacute;N O INCINERACI&Oacute;N DESPU&Eacute;S DE LAS 48 HORAS DE HABER OCURRIDO EL FALLECIMIENTO', 'boolean', '', 'key_F_comprob'),
(61, 'ACTA DE NO INCONVENIENCIA DE LA PROCURADUR&Iacute;A GENERAL DE JUSTICIA DEL DISTRITO FEDERAL O SU EQUIVALENTE EN EL RESTO DE LAS ENTIDADES FEDERATIVAS. EN CASO DE EXISTIR INVESTIGACI&Oacute;N JUDICIAL RELACIONADA CON LA CAUSA DE LA DEFUNCI&Oacute;N', 'boolean', '', 'key_F_acta'),
...
(70, 'Grupo I', 'boolean', '', 'key_grupo1'),
(71, 'Grupo II y Grupo III', 'boolean', '', 'key_grupo23');
...
`id_dat_sec_sol` int(11) NOT NULL,
  `dss_nombre` varchar(320) COLLATE utf8_unicode_ci NOT NULL,
...
(3, 'RAZ&Oacute;N SOCIAL O DENOMINACI&Oacute;N DEL ESTABLECIMIENTO:', 'texto', 'required', 'key_razonsoc'),
...
(12, 'SUPERFICIE TOTAL DE CONSTRUCCI&Oacute;N ', 'int', 'total', 'key_superficie'),
...
(22, 'DESCRIPCI&Oacute;N SCIAN:', 'texto', 'required', 'key_des_scian'),
...
(25, 'TIPO ASESOR&Iacute;A:', 'radio', 'PRODUCTOS Y SERVICIOS;INSUMOS PARA LA SALUD;', 'key_asesoria'),
...
(53, 'CAUSA DE LA DEFUNCI&Oacute;N:', 'texto', 'required', 'key_causa'),
...
(18, 2, 'MAXIMILIANO'),
(18, 3, 'MAXIMILIANO'),
(46, 5, 'INSUMOS PARA LA SALUD'),
(46, 6, 'SALUD AMBIENTAL'),
(49, 1, 'LOPEZ '),
(49, 2, 'CARIDAD'),
(49, 3, 'CARIDAD'),
(50, 1, 'JIMENEZ'),
...
(49, 'RECONOCIMIENTO DEL INTERESADO', '', 'Autorización', 'Habilitado', 'formatos/reconocimiento.jpg', 'reconocimiento_del_interesado.php');
...
(1, '2015-09-29', '2015-10-01', 'Tec de Colima', 1, 4, 1),
(2, '2015-09-29', '2015-10-05', 'UDC', 2, 4, 1),
(3, '2015-10-01', '2015-10-11', 'Sala de Videoconfere', 3, 4, 1),
(4, '2015-09-18', '2015-10-01', 'Salon de la Paz', 4, 4, 1),
(5, '2015-10-03', '2015-10-03', 'Coespris Colima', 5, 4, 0),
(6, '2015-10-03', '2015-10-10', 'Tec', 2, 4, 1);
...
`id_oficina` int(11) NOT NULL,
  ...
  `of_rfc` varchar(15) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `oficina` (`id_oficina`, `of_nombre`, `of_calle`, `of_numero`, `id_colonia`, `id_cuenta`, `of_nomenclatura`, `of_dir_relativa`, `of_rfc`) VALUES
(1, 'CENTRO MUNICIPAL DE NEGOCIOS DEL MUNICIPIO DE MANZANILLO, CO', 'OCTAVIO PAZ', 'S/N', 7, 1, 'CMM', 'FRACC. NUEVO SALAHUA, MANZANILLO, COL.', 'SSE-961026-5Q2'),
(2, 'CENTRO MUNICIPAL DE NEGOCIOS DEL MUNICIPIO DE COLIMA, COL.', 'VENUSTANIO CARRANZA', 'NO.90', 2, 1, 'CMC', 'ESQUINA MANUEL ALVAREZ, COLIMA, COL.', 'SSE-961026-5Q2'),
(3, 'CENTRO MUNICIPAL DE NEGOCIOS DEL MUNICIPIO DE TECOMAN, COL.', 'HIDALGO', 'S/N', 3, 1, 'CMT', 'PRESIDENCIA MUNICIPAL', 'SSE-961026-5Q2'),
(4, 'GERENCIA DE TRAMITES Y AUTORIZACIONES', 'AVENIDA AYUNTAMIENTO', 'S/N', 4, 1, 'GTA', 'ESQ. ARNOLDO VOGEL, COL. BUROCRATAS MUNICIPALES,COLIMA,COL.', ' SSE-961026-5Q2'),
(5, 'COORDINACI&Oacute;N DE OFICINA DE LA JURISDICCI&Oacute;N SANITARIA NO. 1', 'AV. 20 DE NOVIEMBRE', 'S/N', 5, 1, 'CS1', 'ESQ. JUAREZ, COL. CENTRO,COLIMA, COL.', 'SSE-961026-5Q2'),
(6, 'COORDINACI&Oacute;N DE OFICINA DE LA JURISDICCI&Oacute;N SANITARIA NO. 2', 'MORELOS', 'NO.411', 6, 1, 'CS2', 'COL. CENTRO,TECOMAN, COL.', 'SSE-961026-5Q2'),
(7, 'COORDINACI&Oacute;N DE OFICINA DE LA JURISDICCI&Oacute;N SANITARIA NO. 3', 'ELIAS ZAMORA VERDUZCO', 'S/N', 7, 1, 'CS3', 'COL. SALAHUA,MANZANILLO, COL.', 'SSE-961026-5Q2'),
(8, 'CENTRO MUNICIPAL DE NEGOCIOS DEL MUNICIPIO DE VILLA DE ALVAREZ, COL.', 'J. MERCED CABRERA', 'NO.55', 8, 1, 'CMV', 'PRESIDENCIA MUNICIPAL, VILLA DE ALVAREZ, COL.', 'SSE-961026-5Q2');
...
(4, '2015-10-02 12:21:44', 265.8, 265.8, 4, 1, 37, 2),
(5, '2015-10-02 12:46:07', 398.7, 398.7, 5, 1, 35, 2),
(6, '2015-10-02 12:53:23', 398.7, 398.7, 6, 1, 35, 2),
(7, '2015-10-02 13:02:40', 1993.5, 5980.5, 7, 1, 23, 2),
(8, '2015-10-04 18:22:12', 265.8, 265.8, 8, 1, 37, 2);
...
`id_folio` bigint(20) NOT NULL,
  ...
  `id_formato` smallint(6) NOT NULL,
  `id_empleado` int(11) NOT NULL,
  `rp_autorizo` varchar(80) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `recibo_pago` (`id_folio`, `rp_fecha_emision`, `rp_fecha_voucher`, `rp_referencia`, `rp_importe_voucher`, `id_orden_pago`, `id_formato`, `id_empleado`, `rp_autorizo`) VALUES
(1, '2015-10-01 23:13:53', '2015-10-01', '1234567890', 132.9, 1, 5, 2, ''),
(2, '2015-10-01 23:42:47', '2015-10-01', '1234567890', 664.5, 2, 5, 2, ''),
(3, '2015-10-02 00:19:14', '2015-10-02', '1234567890', 265.8, 3, 5, 2, ''),
(4, '2015-10-02 12:34:46', '2015-10-02', '1234567890', 265.8, 4, 5, 2, 'ANTONIO ZEPEDA MENDOZA'),
(5, '2015-10-02 12:47:58', '2015-10-02', '1234567890', 398.7, 5, 5, 2, 'ANTONIO ZEPEDA MENDOZA'),
(6, '2015-10-02 12:54:06', '2015-10-02', '0123456789', 398.7, 6, 5, 2, 'ANTONIO ZEPEDA MENDOZA'),
(7, '2015-10-02 13:03:43', '2015-10-02', '1234567890', 5980.5, 7, 5, 2, 'ANTONIO ZEPEDA MENDOZA'),
(8, '2015-10-04 18:22:38', '2015-10-04', '0123456789', 265.8, 8, 5, 2, 'ANTONIO ZEPEDA MENDOZA');
...
(21, 'SOLICITUD PARA EMISION DE CODIGO DE BARRAS PARA PRESCRIBIR ESTUPEFACIENTES', 15, 4, 33, 5, NULL, 46, 'emision', 'fa fa-file'),
...
(34, 'SOLICITUD DE CURSO DE CAPACITACION DEL INTERESADO POR PERSONA', 30, 4, 23, 5, 49, 14, 'curso', 'fa fa-comments'),
...
(4, '2015-10-02 12:19:35', 1, 1, 6, 2, 1, 'ENTREGADO'),
(5, '2015-10-02 12:46:03', 1, 2, 6, 2, 24, 'ENTREGADO'),
(6, '2015-10-02 12:53:21', 1, 1, 6, 2, 35, 'FINALIZADO'),
(7, '2015-10-02 13:02:35', 3, 2, 6, 2, 34, 'ENTREGADO'),
(8, '2015-10-04 18:22:10', 1, 1, 6, 2, 1, 'ENTREGADO');
...
--
-- Volcado de datos para la tabla `solicitud_grupo`
--

INSERT INTO `solicitud_grupo` (`id_solicitud`, `id_grupo`) VALUES
(7, 5);
...
ALTER TABLE `autorizacion`
 ADD PRIMARY KEY (`id_autorizacion`), ADD KEY `id_formato` (`id_formato`), ADD KEY `id_folio` (`id_folio`);

--
-- Indices de la tabla `cliente`
--
ALTER TABLE `cliente`
 ADD PRIMARY KEY (`id_cliente`), ADD KEY `id_colonia` (`id_colonia`);
...
--
ALTER TABLE `colonia`
 ADD PRIMARY KEY (`id_colonia`), ADD KEY `id_localidad` (`id_localidad`);

--
-- Indices de la tabla `cuenta`
--
ALTER TABLE `cuenta`
 ADD PRIMARY KEY (`id_cuenta`), ADD UNIQUE KEY `cn_clabe` (`cn_clabe`);
...
ALTER TABLE `dsa_autorizacion`
 ADD PRIMARY KEY (`id_dat_sec_aut`,`id_autorizacion`), ADD KEY `FK_dss_autorizacion_Autorizacion` (`id_autorizacion`);
...
--
ALTER TABLE `grupo`
 ADD PRIMARY KEY (`id_grupo`), ADD KEY `id_curso` (`id_curso`);
...
ALTER TABLE `localidad`
 ADD PRIMARY KEY (`id_localidad`), ADD KEY `id_municipio` (`id_municipio`);
...
--
ALTER TABLE `oficina`
 ADD PRIMARY KEY (`id_oficina`), ADD KEY `id_colonia` (`id_colonia`), ADD KEY `id_cuenta` (`id_cuenta`);

--
-- Indices de la tabla `orden_pago`
--
ALTER TABLE `orden_pago`
 ADD PRIMARY KEY (`id_folio_orden`), ADD KEY `id_solicitud` (`id_solicitud`), ADD KEY `id_cuenta` (`id_cuenta`), ADD KEY `id_formato` (`id_formato`);

--
-- Indices de la tabla `permiso`
--
ALTER TABLE `permiso`
 ADD PRIMARY KEY (`id_permiso`), ADD UNIQUE KEY `UQ_permisos_per_archivo` (`per_archivo`);

--
-- Indices de la tabla `permiso_rol`
--
ALTER TABLE `permiso_rol`
 ADD PRIMARY KEY (`id_permiso`,`id_rol`), ADD KEY `id_permiso` (`id_permiso`), ADD KEY `id_rol` (`id_rol`);

--
-- Indices de la tabla `permiso_usuario`
--
ALTER TABLE `permiso_usuario`
 ADD PRIMARY KEY (`id_permiso`,`id_usuario`), ADD KEY `id_permiso` (`id_permiso`), ADD KEY `id_usuario` (`id_usuario`);
...
ALTER TABLE `recibo_pago`
 ADD PRIMARY KEY (`id_folio`), ADD KEY `id_orden_pago` (`id_orden_pago`), ADD KEY `id_formato` (`id_formato`);

--
-- Indices de la tabla `requisito`
--
ALTER TABLE `requisito`
 ADD PRIMARY KEY (`id_requisito`), ADD UNIQUE KEY `UQ_Requisitos_id_requisito` (`id_requisito`);
...
ALTER TABLE `servicio`
 ADD PRIMARY KEY (`id_servicio`), ADD KEY `id_salario_minimo` (`id_salario_minimo`), ADD KEY `id_formato_orden` (`id_folio_orden`), ADD KEY `id_formato_recibo` (`id_formato_recibo`), ADD KEY `id_formato_autoriza` (`id_formato_autoriza`);
...
ALTER TABLE `solicitud`
 ADD PRIMARY KEY (`id_solicitud`), ADD KEY `id_cliente` (`id_cliente`), ADD KEY `id_oficina` (`id_oficina`), ADD KEY `id_empleado` (`id_empleado`), ADD KEY `id_servicio` (`id_servicio`);
...
--
ALTER TABLE `usuario`
 ADD PRIMARY KEY (`id_usuario`), ADD UNIQUE KEY `UQ_usuario_usuario` (`usuario`), ADD KEY `id_empleado` (`id_empleado`), ADD KEY `id_rol` (`id_rol`);
...
--
ALTER TABLE `autorizacion`
MODIFY `id_autorizacion` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `datos_secundarios_autorizacion`
MODIFY `id_dat_sec_autorizacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=72;
--
...
--
ALTER TABLE `estado`
MODIFY `id_estado` smallint(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `formato`
MODIFY `id_formato` smallint(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `orden_pago`
MODIFY `id_folio_orden` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `recibo_pago`
MODIFY `id_folio` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `solicitud`
MODIFY `id_solicitud` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
