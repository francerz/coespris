...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-09-2015 a las 17:38:32
...
(2, 'AXEL GERMAN', 'FUENTES', 'CASTELLANOS', 'REVOLUCION', 453, 5),
...
INSERT INTO `grupo` (`id_grupo`, `det_fecha_inicio`, `det_fecha_fin`, `det_sede`, `id_curso`, `id_empleado`) VALUES
(1, '2015-02-25', '2015-02-03', 'Teatro Hidalgo', 1, 4),
(2, '2015-10-15', '2015-02-13', 'Salon de la paz', 3, 4),
(3, '2015-09-19', '2015-02-12', 'Teatro Hidalgo', 2, 4);
...
(61, '2015-09-21 10:17:12', 1993.5, 7974, 86, 1, 36, 2),
(62, '2015-09-21 10:21:16', 1993.5, 1993.5, 87, 1, 36, 2);
...
(34, 'SOLICITUD CURSO DE CAPACITACION DEL INTERESADO POR PERSONA', 30, 4, 36, 5, NULL, 14, 'curso', 'fa fa-comments');
...
(86, '2015-09-21 10:17:10', 4, 10, 6, 2, 34, 'ORDEN PAGO'),
(87, '2015-09-21 10:21:15', 1, 10, 6, 2, 34, 'ORDEN PAGO');
...
--
ALTER TABLE `orden_pago`
  MODIFY `id_folio_orden` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=63;
--
...
--
ALTER TABLE `servicio`
  MODIFY `id_servicio` smallint(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT de la tabla `solicitud`
--
ALTER TABLE `solicitud`
  MODIFY `id_solicitud` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=88;
--
