...
$CL = "SELECT * FROM solicitud s INNER JOIN cliente cl using(id_cliente) WHERE id_solicitud = $i";
...
//domicilio
$dd = "SELECT * FROM dss_solicitud INNER JOIN datos_secundarios_solicitud using(id_dat_sec_sol) WHERE id_solicitud = '$i' and dss_clave='key_domicilio'";
$ddd = mysql_query($dd,$dbConn); 
$roky = mysql_fetch_array($ddd);
//localidad
$loc = "SELECT * FROM dss_solicitud INNER JOIN datos_secundarios_solicitud using(id_dat_sec_sol)WHERE id_solicitud = '$i' and dss_clave='key_municipio'";
$vcp= mysql_query($loc,$dbConn); 
$roki = mysql_fetch_array($vcp);
//lema
...
<br>
			...
			<table style="width:100%" class="ordenes" id="orden">
			  ...
			  <tr>
			    	...
			    	<td><?=$roky['valor_capturado']?></td>		
			  </tr>
			  <tr>
			    	<td>Localidad:</td>
			    	<td><?=$roki['valor_capturado']?></td>		
...
<br>
		<div id="firmas">
			...
			<h5 align="center" align="justify">I.B.Q. RICARDO JIM&Eacute;NEZ HERRERA<br>
