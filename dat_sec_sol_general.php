...
if (isset($_POST['guardar'])) {
  ...
  mysql_query("INSERT INTO dss_servicio VALUES ('$dato_sec','$id')");?>
...
if (isset($_POST['nuevo'])) {
  ...
  $clave = $_POST['clave'];
  $extra = $_POST['extra'];
  mysql_query("INSERT INTO datos_secundarios_solicitud VALUES ('','$nombre','$tipo','$extra','$clave')");
...
if (isset($_POST['eliminar'])) {
  $dato_sec = $_POST['dato_sec'];
  mysql_query("DELETE FROM dss_servicio WHERE id_dat_sec_sol = '$dato_sec' AND id_servicio = '$id'");?>
  <script type="text/javascript">
    alert("Dato Secundario Eliminado");
  </script>
<?php }

$query = "SELECT * FROM datos_secundarios_solicitud";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel-body">
              <h2>Datos Secundarios de Solicitud</h2>
            </div>
          </div>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <?php while($row = mysql_fetch_array($result)):?>
                      <tr class="odd gradeX">
                          ...
                          <td><?=$row['dss_extras']?></td>
                          <td><?=$row['dss_clave']?></td>
                          <td style="text-align:center"><input type='radio' value='<?=$row['id_dat_sec_sol']?>' name='dato_sec'/></td>
                      </tr>
                    <?php endwhile; ?>
                    </tbody>
                  </table>
          ...
          <div class="col-md-6">
            <div class="panel panel-default">
              <div class="panel-heading">
            <?php $result = mysql_query("SELECT dss.dss_nombre, dss.dss_tipo_dato, dss.id_dat_sec_sol FROM datos_secundarios_solicitud AS dss INNER JOIN dss_servicio AS ds ON dss.id_dat_sec_sol = ds.id_dat_sec_sol WHERE ds.id_servicio = '$id'");?>
